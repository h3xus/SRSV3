<template>
  <div class="max-w-xs rounded-md shadow-md bg-gray-50 text-gray-800">
    ...
    <div class="flex flex-col justify-between p-6 space-y-8">
      <div class="space-y-2">
        <h2 class="text-3xl font-semibold tracki">Donec lectus leo</h2>
      ...
      <button
        type="button"
        class="flex items-center justify-center w-full p-3 font-semibold tracki rounded-md bg-emerald-600 text-gray-50"
      >
        Read more
      </button>
    </div>
