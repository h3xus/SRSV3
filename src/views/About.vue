<template>
  ...
  >
    <div>
      <h2 class="text-3xl font-medium text-gray-800">{{ $t("dashboard.dashboard") }}</h2>
    ...
    <div class="flex flex-col mt-6 md:flex-row md:-mx-1 md:mt-0">
      ...
      >
        <div class="flex items-center justify-center -mx-1">
          ...
          <span class="mx-1 text-sm capitalize">{{ $t("dashboard.cnmeeting") }}</span>
        </div>
      </button>
    </div>
  </section>
  ...
  <section
    class="grid grid-cols-1 gap-8 px-6 xl:grid-cols-3 2xl:grid-cols-4 md:grid-cols-2"
  >
    <div
      class="flex items-center px-6 py-8 bg-white rounded-lg shadow-md shadow-gray-200"
    >
    ...
    <div class="row-span-3 bg-white rounded-lg shadow-md shadow-gray-200">
      <div
        class="px-6 py-5 border-b border-gray-100 sm:flex sm:items-center sm:justify-between"
      >
        <h2 class="font-medium text-gray-700">Students by average mark</h2>

        <button
          type="button"
          class="inline-flex focus:outline-none justify-center mt-2 text-sm font-medium leading-5 text-gray-500 bg-white rounded-lg sm:mt-0 hover:text-gray-600"
        >
